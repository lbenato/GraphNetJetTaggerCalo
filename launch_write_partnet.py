...
out_folder = '/nfs/dust/cms/group/cms-llp/dataframes_jh/v3_calo_AOD_2018_partnet/'#out dir for write_

in_convert = '/nfs/dust/cms/group/cms-llp/dataframes_jh/v3_calo_AOD_2018_partnet/'
...
var_list_tree = event_var_in_tree + jet_list_tree + pf_list_tree # + fat_jet_list_tree
...
def do_write(in_folder, out_folder, cols=var_list_tree):
    for a in sgn+bkg:
        for i, s in enumerate(samples[a]['files']):
            ...
            if not(os.path.exists('/nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_write_partnet/'+s)):
                os.mkdir('/nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_write_partnet/'+s)
            ...
            for b in range(0,max_loop,root_files_per_job):
                ...
                os.chdir('/nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_write_partnet/'+s+'/')
                ...
                with open('write_macro_'+str(j_num)+'.py', 'w') as fout:
                    ...
                    for c in np.arange(start,stop+1):
                        fout.write('write_h5_v4(IN,OUT,"'+root_files[c]+'",xs,LUMI,cols,tree_name="skim",counter_hist="c_nEvents",sel_cut ="") \n')
                ...
                with open('job_write_'+str(j_num)+'.sh', 'w') as fout:
                    ...
                    fout.write('python /nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_write_partnet/'+s+'/write_macro_'+str(j_num)+'.py'  +' \n')
                os.system('chmod 755 job_write_'+str(j_num)+'.sh')

                #CONDOR
                with open('submit_write_'+str(j_num)+'.submit', 'w') as fout:
                    fout.write('executable   = /nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_write_partnet/'+s+'/job_write_'+ str(j_num) + '.sh \n')
                    fout.write('output       = /nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_write_partnet/'+s+'/out_write_'+ str(j_num) + '.txt \n')
                    fout.write('error        = /nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_write_partnet/'+s+'/error_write_'+ str(j_num) + '.txt \n')
                    fout.write('log          = /nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_write_partnet/'+s+'/log_write_'+ str(j_num) + '.txt \n')
                    fout.write(' \n')
                ...
                ##submit condor
                os.chdir('../../.')
                os.system('condor_submit /nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_write_partnet/'+s+'/submit_write_'+str(j_num)+'.submit' + ' \n')
...
def do_convert(inp,out,nj,npf,cols):
    for a in sgn+bkg:
        for i, s in enumerate(samples[a]['files']):
            ...
            print("Prepare condor submission scripts")
            if not(os.path.exists('/nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_conv_partnet/'+s)):
                os.mkdir('/nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_conv_partnet/'+s)
            ...
            for b in range(0,max_loop,root_files_per_job):
                ...
                #print("Start & stop: ", start, stop)
                print("Submitting job n. : ", j_num)
                os.chdir('/nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_conv_partnet/'+s+'/')
                ...
                with open('job_convert_'+str(j_num)+'.sh', 'w') as fout:
                    ...
                    fout.write('cd /nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/ \n')
                    fout.write('source activate /nfs/dust/cms/user/heikenju/anaconda2/envs/particlenet \n')
                    fout.write('python /nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_conv_partnet/'+s+'/convert_macro_'+str(j_num)+'.py'  +' \n')
                os.system('chmod 755 job_convert_'+str(j_num)+'.sh')

                #CONDOR
                with open('submit_convert_'+str(j_num)+'.submit', 'w') as fout:
                    fout.write('executable   = /nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_conv_partnet/'+s+'/job_convert_'+ str(j_num) + '.sh \n')
                    fout.write('output       = /nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_conv_partnet/'+s+'/out_convert_'+ str(j_num) + '.txt \n')
                    fout.write('error        = /nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_conv_partnet/'+s+'/error_convert_'+ str(j_num) + '.txt \n')
                    fout.write('log          = /nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_conv_partnet/'+s+'/log_convert_'+ str(j_num) + '.txt \n')
                    fout.write(' \n')
                    fout.write('#Requirements = OpSysAndVer == "CentOS7" \n')
                    fout.write('##Requirements = OpSysAndVer == "CentOS7" && CUDADeviceName == "GeForce GTX 1080 Ti" \n')
                    fout.write('#Request_GPUs = 1 \n')
                ...
                ##submit condor
                os.chdir('../../.')
                os.system('condor_submit /nfs/dust/cms/user/heikenju/ML_LLP/GraphNetJetTaggerCalo/condor_conv_partnet/'+s+'/submit_convert_'+str(j_num)+'.submit' + ' \n')
