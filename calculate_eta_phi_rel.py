...
IN  = '/nfs/dust/cms/group/cms-llp/dataframes_final_Julia/v3_calo_AOD_2018_dnn__v5_HH/'
OUT = '/nfs/dust/cms/group/cms-llp/dataframes_final_Julia/v3_calo_AOD_2018_dnn__v5_HH/'
...
def do_calc_eta_phi_rel(type_dataset):
    ...
    df.to_hdf(OUT+type_dataset+'_rel'+'.h5', 'df', format='fixed')

    del df
    
for a in ["AK4jets_train","AK4jets_test","AK4jets_val"]:      

    print("Preparing: ", a)   
    do_calc_eta_phi_rel(a)
    print("Done: ", a)